            ...
            <ul class="nav nav-secondary">
                ...
                @if (auth()->user()->can('view room'))
                    <li class="nav-item">
                        ...
                        <div class="collapse @if (Route::is('rooms.*') || Route::is('room-prices.*')|| Route::is('amenities.*')) show @endif" id="room-management">
                            <ul class="nav nav-collapse">
                                ...
                                @if (auth()->user()->can('view amenity'))
                                    <li class="@if (Route::is('amenities.index')) active @endif">
                                        <a href="{{ route('amenities.index') }}">
                                            <span class="sub-item">@lang('Amenities')</span>
                                        </a>
                                    </li>
                                @endif
                            </ul>
                ...
                @can('view expense')
                    <li class="nav-item">
                        <a data-toggle="collapse" href="#Expense"
                            @if (Route::is('expense_transactions.*') || Route::is('expense_categories.*') || Route::is('expense_dashboard.*')) aria-expanded="true"
