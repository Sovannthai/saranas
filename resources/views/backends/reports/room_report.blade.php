...
@section('contents')
    ...
    <div class="card">
        ...
        <div id="collapse-filters" class="collapse show" aria-labelledby="heading-filters">
            <div class="mt-1 ml-2 mr-2 mb-4">
                ...
                <div>
                    <a href="{{ route('reports.room') }}" class="btn btn-outline-danger float-left text-capitalize mb-3 mt-3">@lang('Reset Filter')</a>
                </div>
            </div>
        </div>
    </div>
    <div class="card">
        ...
        <div class="card-body">
            <table id="contracts-table" class="table table-bordered text-nowrap table-hover">
